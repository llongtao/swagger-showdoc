...
public class SwaggerUtils {
    ...
    private static String generateMd(Swagger swagger, String k, Path swaggerPath) {
        StringBuilder builder = new StringBuilder();
...
//        System.out.println(s);
    ...
    private static void doShowDoc(String showDocApiUrl, Path path, Tag tag, Swagger swagger, String apiPath, String apiKey, String apiToken) {
        if (null != path.getPost() && path.getPost().getTags().contains(tag.getName())) {
            sendToShowDoc(showDocApiUrl, apiKey, apiToken, moduleName, tag.getName(), getApiDescription(path), SwaggerUtils.generateMd(swagger, apiPath, path), "");
        }
    ...
    public static void updateToShowDoc(String showDocUrl, String apiKey, String apiToken, Swagger swagger, String moduleName) {
        ...
        tags.forEach(tag -> {
            ...
            paths.forEach((k, v) -> {
                ...
                doShowDoc(showDocApiUrl, v, tag, swagger, k, apiKey, apiToken);
            });
